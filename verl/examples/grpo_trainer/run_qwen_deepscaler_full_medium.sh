...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/workspace/action_abstraction/verl_data/sft_dataset_0_05/train.parquet \
    ...
    actor_rollout_ref.model.path=/deepscaler_easy_hf/deepscaler_easy_hf \
    ...
    trainer.project_name='verl_deepscaler_medium' \
    trainer.experiment_name='verl_deepscaler_medium_1.7B' \
