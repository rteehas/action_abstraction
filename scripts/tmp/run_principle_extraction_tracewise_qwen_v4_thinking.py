...
PROMPT_PATH = REPO_ROOT / 'prompt_templates/principle_extraction_template_v4.txt'
OUTPUT_DIR = REPO_ROOT / 'outputs/2026-03-19/contrastive_abstraction_prompting/principle_extractions_tracewise_qwen_v4_thinking_r1'
