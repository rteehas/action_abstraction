...
PROMPT_PATH = REPO_ROOT / 'prompt_templates/principle_extraction_template.txt'
OUTPUT_DIR = REPO_ROOT / 'outputs/2026-03-19/contrastive_abstraction_prompting/principle_extractions_tracewise_deepseek_r1_distill_qwen_1_5b_r1'
